                ...
                <aside className='order-1 space-y-3 lg:w-[260px]'>
                    <section className='rounded-[14px] border-[0.5px] border-[#d3d1c7] bg-white p-4'>
                        ...
                        <button
                            ...
                            className='mt-4 inline-flex w-full items-center justify-center gap-2 rounded-[10px] border-[0.5px] border-[#d3d1c7] bg-white px-3 py-[10px] text-sm font-medium text-[#2c2c2a] hover:bg-[#f8f8f5]'>
                            <i className={isProfileEditorOpen ? 'ri-close-line' : 'ri-edit-line'}></i>
                            {isProfileEditorOpen ? 'Close editor' : 'Edit profile'}
                        </button>

                        {isProfileEditorOpen && (
                            <form onSubmit={updateProfile} className='mt-4 border-t-[0.5px] border-[#e8e7e0] pt-4'>
                                <div>
